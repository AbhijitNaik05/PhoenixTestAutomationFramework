...
public class CreateJobAPIwithDBValidationTest2 {
	...
	public void setup() {
		...
		customerAddress = new CustomerAddress("605", "Kohinoor", "MG Road", "Phoenix mall", "Pune", "410033", "India",
				"maharashtra");
		customerProduct = new CustomerProduct(getTimeWithDaysAgo(10), "44555355528010", "44555355528010",
				"44555355528010", getTimeWithDaysAgo(10), Product.NEXUS_2.getCode(), Model.NEXUS_2_BLUE.getModel());
