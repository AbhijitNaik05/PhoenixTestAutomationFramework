...
public class AllureEnviornmentWriterUtil {

	private static final Logger LOGGER = LogManager.getLogger(AllureEnviornmentWriterUtil.class);

	public static void createEnviornmentProperties() {
		String folderPath = "target/allure-results";
		File file = new File(folderPath);
		file.mkdirs();

		Properties prop = new Properties();
		prop.setProperty("Name", "Abhijit");
